...
var GameControl = (function (_super) {
    ...
    GameControl.prototype.render = function () {
        ...
        var soundController = SoundControl.getIns();
        ...
        var world = new P2Simulation(0, 200);
        var walls = world.createWall(new egret.Rectangle(0, 0, GameData.stageW, GameData.stageH));
        //this.addChild(world);
        ...
        var pipeHight = left.displays[0].height / 2;
        var pipeY = GameData.stageH - pipeHight - 100;
        ...
        var conMask = moon.MoonUI.getRect(GameData.stageW, GameData.stageH - 200, 0, 0, 160);
